...
data_source_path = "data/Conductivity.csv"
...
# Training parameters
epoch_train = 150  # Epochs for initial training
lr_train = 0.0001  # Learning rate for initial training
...
update_G_lr = 0.00002  # Learning rate for threshold generator updates
